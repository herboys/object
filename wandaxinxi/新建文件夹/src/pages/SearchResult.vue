        ...
        <div class="main-bottom">
            <div class="search-result" style="height:40px;margin-bottom:10px;margin-top:10px;">
                <div class="result-left">
                    ...
                    <select id="" style="text-indent:5px;outline:none;width:150px;height:40px;border-radius:4px;border: 1px solid #D8D8D8;margin-left:0;">
                        <option value="">展示字段</option>
                        <option value="">ID</option>
                        <option value="">性别</option>
                        <option value="">门诊诊断</option>
                        <option value="">出院诊断</option>
                        <option value="">主诉</option>
                        <option value="">现病史</option>
                        <option value="">既往史</option>
                        <option value="">家族史</option>
                    </select>
            ...
            <div id="viewTable" class="view">
                 <el-table
                  ...
                  :cell-style="{padding:'1px'}"
                    ...
                    <el-table-column prop="sex" label="性别" width="80" height="60" align="center">
                        <template slot-scope="scope">
                            <p v-html="scope.row.sex"></p>
                        </template>
                    </el-table-column>
                    <el-table-column prop="qutpatient" label="门诊诊断" width="120" height="120" align="center">
                         <template slot-scope="scope">
                    ...
                    <el-table-column prop="admission" label="入院诊断" width="120" height="120" align="center">
                        <template slot-scope="scope">
                    ...
                    <el-table-column prop="discharge" label="出院诊断" width="120" height="120" align="center">
                        <template  slot-scope="scope">
                    ...
                    <el-table-column prop="departments" label="就诊科室" width="120" align="center">
                        <template  slot-scope="scope">
                    ...
                    <el-table-column prop="CheckTime" label="检查时间" width="120" align="center">
                          <template slot-scope="scope">
                    ...
                    <el-table-column prop="hospital" label="就诊医院" width="120" align="center">
                        <template slot-scope="scope">
